...
const Button = props => {
    ...
    const Round = theme === "round" || (Array.isArray(theme) && theme.includes("round"))
        ...
        : {};
    return (react_1.default.createElement(Tag, Object.assign({ style: Object.assign(Object.assign(Object.assign(Object.assign({}, Themes), (disabled ? themes.disabled : {})), Round), Style), disabled: disabled, onPress: onPress, onPressIn: onPressIn, onPressOut: onPressOut }, (feedback === "highlight" ? { underlayColor: underlayColor } : {})), children));
};
