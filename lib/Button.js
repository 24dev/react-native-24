...
const Button = props => {
    const { feedback = "opacity", theme = "invisible", children, style = {}, onPress = () => { }, onPressIn = () => { }, onPressOut = () => { }, disabled = false, size = 50 } = props;
    ...
    const Round = theme === "round" || (Array.isArray(theme) && theme.includes("round"))
        ...
        : {};
    return (react_1.default.createElement(Tag, { style: Object.assign(Object.assign(Object.assign(Object.assign({}, Themes), (disabled ? themes.disabled : {})), Round), Style), disabled: disabled, onPress: onPress, onPressIn: onPressIn, onPressOut: onPressOut }, children));
};
