...
const Input = props => {
    const { height = 40, style = {}, wrapperStyle = {}, multiline = false, value = "", editable = true, placeholder = "", secure = false, forwardRef = () => { }, withIcon = false, icon = react_1.default.createElement(react_1.default.Fragment, null), iconPosition = 'right', iconPaddingRight = 5, iconPaddingLeft = 5, } = props;
    const renderIcon = () => {
        if (iconPosition === 'right') {
            return (react_1.default.createElement(react_native_1.View, { style: Object.assign(Object.assign({}, styles.iconRightWrapper), { right: iconPaddingRight }) }, icon));
        }
        else {
            return (react_1.default.createElement(react_native_1.View, { style: Object.assign(Object.assign({}, styles.iconLeftWrapper), { left: iconPaddingLeft }) }, icon));
        }
    };
